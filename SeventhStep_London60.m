...
X{1} = sprintf('London: NHPP for wind speed >60kmph: %f X + %f and R-squared = %f',p(1),p(2),mdl.Rsquared.Ordinary);
%title(X);
%set(gca,'Ylim',[30 160]) % Adjust Y limits of "current axes"
set(gca,'FontName','Times');
set(gcf,'Units','inches') % Set figure size units of "current figure"
set(gcf,'Color','white');
set(gcf,'Position',[0,0,7.5,2.5]) % Set figure width (6 in.) and height (4 in.)
print -deps2c 3136.eps % Save as PDF
movefile('3136.eps','C:\Users\Maulin Amin\OneDrive - University of Waterloo\Waterloo\Winter 2018\Environment Canada\Thesis\Latex\plots');

%===================================
%WRITE THE DATA ON EXCEL FILE 
%===================================
X = cell2table(X);
File1 = 'C:\Users\Maulin Amin\OneDrive - University of Waterloo\Waterloo\Winter 2018\Environment Canada\Wind&Snow\Step7_Parameters.xlsx';
writetable(X,File1,'Sheet','London60');
