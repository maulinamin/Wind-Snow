...
X{1} = sprintf('KW: NHPP for wind speed >70kmph: %f X + %f and R-squared = %f',p(1),p(2),mdl.Rsquared.Ordinary);
%title(X);
...
print -deps2c 3135.eps % Save as PDF
movefile('3135.eps','C:\Users\Maulin Amin\OneDrive - University of Waterloo\Waterloo\Winter 2018\Environment Canada\Thesis\Latex\plots');
