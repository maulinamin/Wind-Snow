...
% % 
% % for k = 1:loop
% % GOF.Ri_i2i(k) = GOF.Ri(k) - GOF.i2i(k);
% % end
...
% set(gcf,'Color','white');
% set(gcf,'Position',[0,0,5.5,4.5]) % Set figure width (6 in.) and height (4 in.)
% print -deps2c 409.eps % Save as PDF
% movefile('409.eps','C:\Users\Maulin Amin\OneDrive - University of Waterloo\Waterloo\Winter 2018\Environment Canada\Thesis\Latex\plots');
