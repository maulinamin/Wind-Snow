...
X{1} = sprintf('Toronto Island: NHPP for wind speed >60kmph: %f X + %f and R-squared = %f',p(1),p(2),mdl.Rsquared.Ordinary);
%title(X);
...
print -deps2c 3144.eps % Save as PDF
movefile('3144.eps','C:\Users\Maulin Amin\OneDrive - University of Waterloo\Waterloo\Winter 2018\Environment Canada\Thesis\Latex\plots');
...
writetable(X,File1,'Sheet','TorontoIs60');
