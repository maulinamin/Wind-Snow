...
% print -deps2c 314-315-316-317.eps % Scave as PDF
% movefile('314-315-316-317.eps','C:\Users\Maulin Amin\OneDrive - University of Waterloo\Waterloo\Winter 2018\Environment Canada\Thesis\Latex\plots');
...
print -deps2c 3110.eps % Save as PDF
movefile('3110.eps','C:\Users\Maulin Amin\OneDrive - University of Waterloo\Waterloo\Winter 2018\Environment Canada\Thesis\Latex\plots');
...
set(gcf,'Color','white');
set(gcf,'Position',[0,0,3.2,2.5]) % Set figure width (6 in.) and height (4 in.)
print -deps2c 3111.eps % Save as PDF
movefile('3111.eps','C:\Users\Maulin Amin\OneDrive - University of Waterloo\Waterloo\Winter 2018\Environment Canada\Thesis\Latex\plots');
...
print -deps2c 3112.eps % Save as PDF
movefile('3112.eps','C:\Users\Maulin Amin\OneDrive - University of Waterloo\Waterloo\Winter 2018\Environment Canada\Thesis\Latex\plots');
...
set(gcf,'Color','white');
set(gcf,'Position',[0,0,6,4]) % Set figure width (6 in.) and height (4 in.)
print -deps2c 3113.eps % Save as PDF
movefile('3113.eps','C:\Users\Maulin Amin\OneDrive - University of Waterloo\Waterloo\Winter 2018\Environment Canada\Thesis\Latex\plots');
...
% writetable(PPTH60,File,'Sheet','PPPs 70IAT');