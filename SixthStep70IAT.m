...
X = sprintf('Exponential PPP for Interarrival time of wind data > 70KMPH: %f X + %f and R-squared = %f',p(1),p(2),mdl.Rsquared.Ordinary);
title(X);
...
suptitle('PPPs for Interarrival time of Wind Data > 70KMPH')
