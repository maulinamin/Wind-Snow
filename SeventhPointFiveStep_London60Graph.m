...
plot(B.CumTI,B.Cum_Nt,'.');
hold off;
ylabel({'$N(t)$'},'Interpreter','latex'); xlabel({'$t$'},'Interpreter','latex');
set(gca,'FontName','Times');
set(gcf,'Units','inches') % Set figure size units of "current figure"
set(gcf,'Color','white');
set(gcf,'Position',[0,0,3.3,2.5]) % Set figure width (6 in.) and height (4 in.)
print -deps2c 435.eps % Save as PDF
movefile('435.eps','C:\Users\Maulin Amin\OneDrive - University of Waterloo\Waterloo\Winter 2018\Environment Canada\Thesis\Latex\plots');
